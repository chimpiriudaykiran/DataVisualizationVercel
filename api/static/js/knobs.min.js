document.addEventListener("keyup", function(e){ if (e.key === 'Escape') {
    toggle(0);
}});

! function(e, t) {
  "object" == typeof exports && "undefined" != typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define(t) : (e = "undefined" != typeof globalThis ? globalThis : e || self).Knobs = t()
}(this, (function() {
  "use strict";
  ...
  ! function(e, t) {
      ! function(e) {
          var t = e => (new DOMParser).parseFromString(e.trim(), "text/html").body.firstElementChild,
              o = {
                  color: "white",
                  onInput: e => e,
                  onChange: e => e,
          ...
          const a = e => e.match(/\((.*)\)/)[1].split(",").map(Number),
              r = e => Object.assign([0, 0, 0, 1], e.match(/\((.*)\)/)[1].split(",").map(((e, t) => 3 != t || e.includes("%") ? parseFloat(e) : 100 * parseFloat(e)))),
              n = e => `hsla(${e.h}, ${e.s}%, ${e.l}%, ${e.a}%)`,
              i = e => e.toFixed(1).replace(".0", ""),
              s = e => {
                  const [t, o, a, r] = (e => e.match(/\w\w/g))(e), [n, i, s] = [t, o, a].map((e => parseInt(e, 16)));
                  return `rgba(${n},${i},${s},${r ? (parseInt(r, 16) / 255).toFixed(2) : 1})`
              },
              l = e => {
                  var t, o = document.createElement("canvas").getContext("2d");
                  return o.fillStyle = e,
                      "#" == (t = o.fillStyle)[0] ? t : c(t)
              },
              c = e => {
                  const [t, o, r, n] = a(e), i = "#" + [t, o, r].map((e => e.toString(16).padStart(2, "0"))).join("");
              ...
              h = e => {
                  ...
                  return c && (d = p > .5 ? c / (2 - s - l) : c / (s + l),
                      h = s == t ? (o - r) / c + (o < r ? 6 : 0) : h = s == o ? (r - t) / c + 2 : (t - o) / c + 4,
                      h /= 6), {
                      h: i(360 * h),
                      s: i(100 * d),
                      l: i(100 * p),
              ...
              d = (e, t) => (t = (t + "").toLowerCase(),
                  e = l(e),
                  "hex" == t ? e : t.startsWith("hsl") ? n(h(s(e))) : t.startsWith("rgb") ? s(e) : e);
          ...
          function m(e) {
              ...
              const {
                  value: t,
                  max: o
              } = e.target, a = -1 * Math.sign(e.deltaY);
              t && o && (e.target.value = Math.min(Math.max(+t + a, 0), +o),
                  x.call(this, e))
          }
          ...
          function S(e) {
              ...
              "format" == t ? this.swithFormat() : "undo" == t ? this.history.undo() : "addSwatch" == t ? this.addSwatch() : "removeSwatch" == t ? this.removeSwatch(o, o.title) : a.contains("color-picker__swatch") && r && (this.history.last = this.color,
          ...
          var C = Object.freeze({
              ...
              bindEvents: function() {
                  [
                      ...
                      ["scope", "wheel", m],
                      ["value", "change", w]
                  ].forEach((([e, t, o]) => this.DOM[e].addEventListener(t, o.bind(this), {
                          pasive: !1
                      }))),
                      window.addEventListener("storage", f.bind(this)),
                      this.settings.onClickOutside && (document.body.addEventListener("click", _.bind(this)),
                          window.addEventListener("keydown", k.bind(this)))
              }
          });

          function z() {
              const e = () => this.settings.onChange(this.CSSColor),
              ...
              return {
                  ...
                  undo() {
                      if (this._value.length > 1) {
                          this.pop;
                          let o = this._value[this._value.length - 1];
                          return t(o),
                              e(),
                              o
                      }
          ...
          var M = Object.freeze({
              ...
              addSwatch: function(e = this.CSSColor) {
                  ...
                  o.classList.add("cp_remove"),
                      ...
                      setTimeout((() => o.classList.remove("cp_remove")), 0),
              ...
              getSetGlobalSwatches: function(e) {
                  const t = this.settings.swatchesLocalStorage,
                      o = "string" == typeof t ? t : "";
                  return t && e && (localStorage.setItem(O + o, e.join(";")),
                          dispatchEvent(new Event("storage"))),
                      localStorage[O + o]?.split(";").filter(String) || []
              },
              removeSwatch: function(e, t) {
                  e.classList.add("cp_remove"),
                      setTimeout((() => e.remove()), 200);
                  const o = e => e != t;
                  this.swatches = this.swatches.filter(o),
                      this.sharedSwatches = this.sharedSwatches.filter(o),
                      this.getSetGlobalSwatches(this.sharedSwatches)
              },
          ...
          function T(e) {
              ...
              this.DOM = {},
                  ...
                  this.swatches = r && this.sharedSwatches.concat(this.initialSwatches),
                  this.color = d(t, a),
          ...
          T.prototype = {
                  ...
                  ...M,
                  ...C,
                  getColorFormat: e => "#" == e[0] ? "hex" : e.indexOf("hsl") ? e.indexOf("rgb") ? "" : "rgba" : "hsla",
                  getHSLA(e) {
                      let t;
                      if (e)
                          return e + "" == "[object Object]" && Object.keys(e).join("").startsWith("hsl") ? e : (this.colorFormat = this.getColorFormat(e),
                              e.indexOf("hsla") ? (e = l(e),
                                  e = s(e),
                                  t = h(e)) : (t = r(e),
                                  t = {
                                      h: t[0],
                  ...
                  updateRangeSlider(e, t) {
                      const o = this.DOM.scope.querySelector(`input[name="${e}"]`);
                      o && (o.value = t,
                          o.parentNode.style.setProperty("--value", t),
                          o.parentNode.style.setProperty("--text-value", JSON.stringify("" + Math.round(t))),
                          this.updateCSSVar(e, t))
                  },
                  setCSSColor() {
                      this.CSSColor = l(n(this.color)),
                          "rgba" == this.colorFormat ? this.CSSColor = s(this.CSSColor) : "hsla" == this.colorFormat && (this.CSSColor = n(this.color)),
                  ...
                  updateCSSVar(e, t) {
                      this.DOM.scope.style.setProperty(`--${e}`, t)
                  },
                  updateAllCSSVars() {
  ...
  const a = e => {
      ...
      if (r = c ? r : e => e(),
          l = l || [],
          s = (s || " ").split(" ").map(((e, t) => e || ["center", "below"][t])),
          i = i ? [i[0] || 0, i[1] || i[0] || 0] : [0, 0],
          n.parentNode && (t = n.ownerDocument.defaultView,
              ...
              d.h = p.height,
              t != t.parent))
          for (let k of t.parent.document.getElementsByTagName("iframe"))
              if (k.contentWindow === t) {
                  let _ = k.getBoundingClientRect();
                  d.x += _.x,
                      d.y += _.y
              }
      "left" == s[0] ? d.x -= v.w + i[0] : "right" == s[0] ? d.x += d.w + i[0] : d.x -= v.w / 2 - d.w / 2,
          "above" == s[1] ? d.y -= v.h + i[1] : "below" == s[1] ? d.y += d.h + i[1] : d.y -= v.h / 2 - d.h / 2;
      const f = {
              top: d.y < 0,
              bottom: d.y + v.h > g,
              left: d.x < 0,
      ...
      if (f.right && "left" != l[0])
          return m(["left", s[1]]);
      if (f.bottom && "above" != l[1])
          return m([s[0], "above"]);
      if (f.top && "below" != l[1])
          return m([s[0], "below"]);
      if (r((() => {
              o.setAttribute("positioned", !0),
                  o.setAttribute("data-placement", s.join(" ")),
                  o.setAttribute("data-pos-overflow", Object.entries(f).reduce(((e, [t, o]) => o ? `${e} ${t}` : e), "").trim()),
                  [
                      ["pos-left", f.right ? u - v.w : d.x],
                      ["pos-top", d.y],
                      ["pos-target-width", v.w],
                      ["pos-target-height", v.h],
                      ["pos-ref-width", p.width || 0],
                      ["pos-ref-height", p.height || 0],
                      ["pos-ref-left", p.x],
                      ["pos-ref-top", p.y],
                      ["window-scroll-y", window.scrollY],
                      ["window-scroll-x", window.scrollX]
                  ].forEach((([e, t]) => o.style.setProperty("--" + e, Math.round(t))))
          })),
          h?.scroll && !o.position__trackedScroll) {
          function x(t) {
              t.target.contains(refElement) && a(e)
          }
          o.position__trackedScroll = !0,
  ...
  let r = requestAnimationFrame || (e => setTimeout(e, 1e3 / 60));
  var n = e => e + "" == "[object Object]";
  const i = (e, ...t) => {
      if (!t.length)
          return e;
      const o = t.shift();
  ...
  const b = window.requestAnimationFrame || (e => window.setTimeout(e, 1e3 / 60)),
      u = (e, t) => e.classList.contains(t);
  ...
  var v = Object.freeze({
      ...
      bindEvents: function() {
          this.eventsRefs = this.eventsRefs || {
                  ...
                  input(e) {
                      try {
                          let t;
                          u(e.target, "toggleSection") && e.target.checked && (t = e.target.parentNode.querySelector(".fieldset__group"),
                              this.setIframeProps({
                                  heightOffset: 9999
                              }))
                      } catch (e) {}
                      e.target.hasAttribute("is-knob-input") ? (this.onInput(e),
                          this.onChange(e)) : u(e.target, "knobs__knob__toggle") && this.toggleKnob(e.target.dataset.forKnob, e.target.checked)
                  },
                  transitionstart(e) {
                      u(e.target, "fieldset__group__wrap") && e.target.parentNode.setAttribute("transitioned", 1)
                  },
                  transitionend(e) {
                      u(e.target, "fieldset__group__wrap") && (e.target.parentNode.removeAttribute("transitioned"),
                          this.setIframeProps())
                  },
                  wheel(e) {
                      const {
                          ...
                          step: a,
                          type: r
                      } = e.target, n = Math.sign(e.deltaY) * (+a || 1) * -1;
                      "range" == r && e.preventDefault(),
                          t && o && (e.target.value = Math.min(Math.max(+t + n, 0), +o),
                              this.onInput(e),
                              this.onChange(e))
                  },
                  mainToggler(e) {
              ...
              ].forEach((([e, t, o]) => this.DOM[e] && this.DOM[e].addEventListener(t, o || this.eventsRefs[t].bind(this), {
                  passive: !1
              }))),
              g.call(this)
      },
      onChange: function(e, o) {
          const a = e.target.dataset.name;
          this.setKnobChangedFlag(this.getKnobElm(a));
          const r = this.getKnobDataByName(a),
              n = "input" == e.type && r && "range" != r.type,
              i = r && "checkbox" == r.type,
              s = {};
          if (!r)
              return void console.warn("Knob data was not found:", {
                  name: a,
                  knobData: r
              });
          const l = o ? [] : this.getSimilarKnobs(r);
          l.length && l.forEach((e => {
              ...
              (i || this.settings.live) && ("input" == e.type && n || (b((() => this.updateDOM(r))),
                  "color" === r.type && (s.hsla = t.CSStoHSLA(t.changeColorFormat(r.value, "HSL"))),
                  "function" == typeof r.onChange && r.onChange(e, r, s)))
      },
      onClick: function(e) {
          const {
              target: t
          } = e;
          u(t, "knobs__knob__reset") && this.resetKnobByName(t.name),
              "color" == t.dataset.type && setTimeout((e => this.toggleColorPicker(t)), 100)
      },
      onFocus: function(e) {},
      onInput: function(e) {
          const t = e.target,
              ...
              {
                  label: s
              } = this.getKnobDataByName(n);
          this.setParentNodeValueVars(t),
              this.setKnobDataByName(n, i ? {
                  checked: r
              } : {
                  value: a
              }),
      ...
      onSubmit: function(e) {
          ...
          return this.settings.live = !0,
              t.forEach((e => this.onChange({
                  target: {
                      value: e.value,
                      type: e.type,
                      dataset: {
  ...
  const f = "@yaireo/knobs/knobs",
      m = e => "string" == typeof e || "number" == typeof e;
  var k = Object.freeze({
          __proto__: null,
          getPersistedData: function() {
              let e, t = this.settings.persist,
                  o = m(t) ? "/" + t : "";
              if (1 == localStorage.getItem(`${f + o}/v`))
                  try {
          ...
          setPersistedData: function() {
              ...
              if (e) {
                  ...
                  localStorage.setItem(`${f + t}/v`, 1),
                      localStorage.setItem(f + t, e),
                      dispatchEvent(new Event("storage"))
              }
          }
      }),
  ...
  function x(e) {
      ...
      this.settings = i({
          ...
          i(this, function() {
              ...
              function t(t, o, a) {
                  a && o.split(/\s+/g).forEach((o => e[t + "EventListener"].call(e, o, a)))
              }
              return {
                  off(e, o) {
                      return t("remove", e, o),
                  ...
                  on(e, o) {
                      return o && "function" == typeof o && t("add", e, o),
                          this
                  },
                  trigger(t, o, a) {
                      var r;
                      if (a = a || {
                          ...
                          try {
                              ...
                              if ((n = a.cloneData ? i({}, n) : n).knobs = this,
                                  o instanceof Object)
                                  for (var s in o)
                                      o[s] instanceof HTMLElement && (n[s] = o[s]);
                              r = new CustomEvent(t, {
                                  detail: n
                              })
                          } catch (e) {
  ...
  return x.prototype = {
          ...
          cloneKnobs: function(e, t) {
              return e.map((e => {
                  if (e && e.type) {
                      if (e.__name = e.__name || (e.label?.replaceAll(/[^a-zA-Z0-9 ]/g, "").replaceAll(" ", "-").toLowerCase() || "") + "-" + s(),
                          e.defaultValue = e.defaultValue ?? e.value ?? this.getKnobValueFromCSSVar(e) ?? "",
                          e.defaultChecked = e.defaultChecked ?? !!e.checked,
                          e.isToggled = e.isToggled ?? !0,
                          t) {
                          let o = t.find((t => t.label && t.label == e.label));
                          if (o)
                              return e.defaultValue && (o.defaultValue = e.defaultValue),
                                  e.options && (o.options = e.options),
                                  o
                      }
                      "range" == e.type ? (e.value = +e.value || e.defaultValue,
                          e.defaultValue = +e.defaultValue) : "checkbox" == e.type ? e.checked = e.checked || e.defaultChecked : e.value = e.value || e.defaultValue
                  }
                  return e.render && (e.__name = "custom-" + s()),
                      e.cssVar ? {
                          ...e,
                          cssVar: [...e.cssVar]
                      } : n(e) ? {
          ...
          set knobs(e) {
              e && e instanceof Array && (this._knobs = this.cloneKnobs(e, this.getPersistedData()),
          ...
          getCSSVariables({
              ...
              const l = t.changeColorFormat(n["base-color"], "hsl"),
                  c = t.CSStoHSLA(l);
              for (i in n["base-color"] = `${c[0]}, ${c[1]}%`,
                  n["base-color-l"] = `${c[2]}%`,
                  n["base-color-a"] = `${c[3]}%`,
                  n)
                  s += `--${i}:${n[i]}; `;
          ...
          getKnobValueFromCSSVar(e) {
              ...
              if (!("value" in e) && e.cssVar && e.cssVar.length) {
                  let o = e.cssVar[2] || this.settings.CSSVarTarget;
                  return o.length && (o = o[0]),
                      t = getComputedStyle(o).getPropertyValue(`--${e.cssVar[0]}`).trim(),
                      "range" == e.type && (t = parseInt(t)),
                      "color" != e.type || t || (t = "transparent"),
                      t
              }
          },
          templates: p,
          toggleColorPicker(e) {
              ...
              let s = e.colorPicker;
              if (s)
                  return void s.DOM.scope.classList.remove("hidden");
              s = s || new o({
                      ...
                      onClickOutside(t) {
                          const o = s.DOM.scope.classList.contains("hidden");
                          c.observe(document.body),
                              h.observe(s.DOM.scope);
                          let a = "add";
                          t.target == e && (a = "toggle"),
                              "Escape" == t.key && (a = "add"),
                              o || (c.unobserve(document.body),
                                  h.unobserve(s.DOM.scope)),
                              s.DOM.scope.classList[a]("hidden")
                      },
                      onInput(t) {
                          e.value = t,
                              i.onInput({
                  ...
                  document.body.contains(s.DOM.scope) || (s.DOM.scope.insertAdjacentHTML("afterbegin", `<h1>${n.label}</h1>`),
                      e.colorPicker = s,
                      this.DOM.iframe.before(s.DOM.scope));
              const l = () => {
                      a({
                          target: s.DOM.scope,
                          ref: e
              ...
              c.observe(document.body),
                  ...
                  l(),
                  setTimeout((() => {
                      s.DOM.scope.querySelector("input").focus(),
                          s.DOM.scope.classList.remove("hidden")
                  }), 100)
          },
          knobAttrs(e) {
              var t = `data-name="${e.__name}" is-knob-input`,
              ...
              for (var a in "radio" === e.type && e.groupValue === e.value && (e.checked = !0),
                      e)
                  ("checked" != a || e[a]) && (o.includes(a.toLowerCase()) || (t += ` ${a}="${e[a]}"`));
              return t
          },
          getKnobDataByName(e) {
              return this.knobs.filter(Boolean).find((t => t.__name == e))
          },
          ...
          getInputByName(e) {
              const t = this.getKnobElm(e).querySelectorAll(`[data-name="${e}"`);
              return t.length > 1 ? t : t[0]
          },
          getKnobElm(e) {
              return this.DOM.scope.querySelector(`#${e}`)
          },
          getSimilarKnobs(e) {
              return this.knobs.filter((t => t?.cssVar?.[0] && t?.cssVar?.[0] == e?.cssVar?.[0] && t.__name != e.__name))
          },
          setParentNodeValueVars(e) {
              e && [
                  ["--value", e.value],
                  ["--text-value", JSON.stringify(e.value)]
              ].forEach((([t, o]) => e?.parentNode.style.setProperty(t, o)))
          },
          updateDOM({
              cssVar: e,
              value: o,
              ...
              if (e && e.length) {
                  var [s, l, c] = e, h = c || this.settings.CSSVarTarget, d = this.getInputByName(i), p = "setProperty", b = [
                      [s, o]
                  ];
                  if (l && "-" != l[0] && (b[0][1] += l || ""),
                      (!r || "checkbox" == a && d && !d.checked) && (p = "removeProperty"),
                      "color" == a && n) {
                      const e = t.CSStoHSLA(t.changeColorFormat(o, "HSL"));
                      b.push([`${s}-h`, e[0]], [`${s}-s`, e[1] + "%"], [`${s}-l`, e[2] + "%"], [`${s}-a`, e[3] + "%"])
                  }
                  if (Object.prototype.toString.call(h).includes("Element") && (h = [h]),
                      h && h.length && void 0 !== o && s)
                      for (let e of h)
                          for (let [t, o] of b)
                              e.style[p](`--${t}`, o)
              }
          ...
          applyKnobs(e, t) {
              (e || this.knobs).forEach((e => {
                  if (e && e.__name && !e.render) {
                      var o, a, r = t => e.type == t,
                          n = this.getInputByName(e.__name),
                          i = t ? "defaultValue" : "value",
                          s = t ? "defaultChecked" : "checked";
                      r("radio") && (n = [...n],
                              t ? (n = n.find((t => t.value == e[i]))).checked = !0 : n = n.find((e => e.checked))),
                          o = {
                              target: n
                          },
                          this.setParentNodeValueVars(n),
                          e.type && !1 !== e.isToggled && (r("checkbox") ? (a = n.checked = !!e.checked,
                                  n.checked = e[s]) : a = n.value = e[i],
                              this.setResetKnobTitle(e.__name, a),
                              "" === n.value && n.value !== e[i] || (this.onInput(o),
                                  this.onChange(o, !0)),
                              setTimeout((() => {
                                  r("checkbox") || (n.value = e[i]),
                                      r("color") && (n.title = n.value)
                              })),
                              this.setKnobChangedFlag(this.getKnobElm(e.__name), e.value != e.defaultValue))
                  }
              }))
          },
          setResetKnobTitle(e, t) {
              try {
                  t = "Reset to " + t,
                      this.getKnobElm(e).querySelector(".knobs__knob__reset").title = t
              } catch (e) {}
          },
          resetKnobByName(e) {
              this.setKnobChangedFlag(this.getKnobElm(e), !1),
                  this.applyKnobs([this.getKnobDataByName(e)], !0)
          },
          calculateGroupsHeights() {
              this.DOM.form.querySelectorAll(".fieldset__group__wrap").forEach((e => {
          ...
          setIframeProps(e) {
              ...
              "setProperty" == t && (o.setProperty("--knobsWidth", "2000px"),
                  o.setProperty("--knobsHeight", "10000px"));
              var {
                  clientWidth: r,
                  clientHeight: n
              } = this.DOM.scope;
          ...
          toggle(e) {
              this.DOM.mainToggler && (void 0 === e && (e = !this.DOM.mainToggler.checked),
          ...
          toggleKnob(e, t) {
              ...
              o.isToggled = t,
                  o[a] = r,
                  this.updateDOM(o),
                  "function" == typeof o.onChange && o.onChange(null, o),
          ...
          build() {
              if (this.settings.standalone)
                  this.DOM.scope = (e = this.templates.knobs.call(this, {
                          withToggler: !1
                          
                      }),
                      (new DOMParser).parseFromString(e.trim(), "text/html").body.firstElementChild);
              else {
                  const e = this.createIframe();
                  this.DOM.scope = e.body.querySelector(".knobs"),
                      this.DOM.groups = e.body.querySelector(".knobs__groups"),
                      this.DOM.mainToggler = e.getElementById("knobsToggle")
              }
              var e;
          ...
          createIframe() {
              var e, t, o = this.settings.theme;
              return this.DOM.iframe = document.createElement("iframe"),
